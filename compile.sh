...
gfortran -o src/dvode_f90_m.o -c src/dvode_f90_m.f90 -J src
gfortran -o src/main.o        -c main.f90 -I src

gfortran -o solve_senkin src/main.o src/dvode_f90_m.o src/chemkin_m.o src/cklib.o src/tranlib.o src/dmath.o